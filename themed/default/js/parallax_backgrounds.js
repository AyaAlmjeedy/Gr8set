        ...
        update: function() {
            ...
            while (i--) {
                var rect = this.elements[i].getBoundingClientRect(),
                    ...
                    documentHeight, pageYOffset, maxPageYOffset, pageYOffsetPercentage, windowHeightConsidered, yPositionInDocument, yMinPosition, yMaxPosition, yPosition, yMin, yMax, backgroundPosition
